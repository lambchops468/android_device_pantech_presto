...
BOARD_KERNEL_CMDLINE            := androidboot.hardware=qcom kgsl.mmutype=gpummu loglevel=6 androidboot.selinux=permissive androidboot.baseband=csfb zram.num_devices=2
